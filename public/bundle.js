	...
	var Weather = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var renderMsg = function renderMsg() {
	      var msg = isLoading ? React.createElement(
	        'h3',
	        null,
	        'Fetching weather...'
	      ) : temp && location ? React.createElement(WeatherMessage, { location: location, temp: temp }) : "";
	      return msg;
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OPEN_WEATHER_MAP_URL = 'http://api.openweathermap.org/data/2.5/weather?appid=368e081da30053c749baefff230518a0&units=imperial';
	...
	var Examples = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      'h3',
	      null,
	      'Here are some examples of the weather, I suppose.'
	    );
	  }
	});
